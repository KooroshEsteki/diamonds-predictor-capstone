...
highest_price_cluster = cluster_summary.loc[
    cluster_summary["price"].idxmax(),
    "cluster"]

lowest_price_cluster = cluster_summary.loc[
    cluster_summary["price"].idxmin(),
    "cluster"]
